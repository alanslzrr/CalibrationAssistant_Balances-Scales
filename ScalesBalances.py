...
def buscar_en_sample_cals(sample_cals_data, certificado_objetivo, grupo_objetivo, nominal_objetivo_str, unidad_objetivo):
    """
                ...
                if datasheet['Group'] == grupo_objetivo:
                    for measurement in datasheet['Measurements']:
                        try:
                            ...
                            # Manejar el error si la conversión de 'Nominal' a float falla
                            continue  # Puede optar por continuar o manejar de otra manera
    raise ValueError("No se encontró coincidencia en SampleCals.json")
